                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-right">
                            ...
                            <form id="delete_all" class="d-none" action="{{route('admin.categories.delete.all')}}" method="post">
                                @csrf
                                <input type="hidden" class="category_ids" name="category_ids" value="">
                            </form>
                        </div>
                    </div>
                </div>
                                ...
                                <td class="text-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            <a class="dropdown-item has-icon" href="{{ route("admin.categories.edit", ['category' => $item]) }}"><i class="fa fa-edit"></i> Show & Edit</a>
...
<script type="text/javascript">
    ...
    function remove_all() {
        ...
        $('.category_ids').val(str.slice(0, -1))
    ...
    function setUserId() {
        ...
        $('.notify_category_ids').val(str.slice(0, -1))
    }
</script>
@endsection
