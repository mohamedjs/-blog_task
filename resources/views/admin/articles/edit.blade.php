        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.articles.update',['article' => $article]) }}" enctype="multipart/form-data" method="post">
                            @method('patch')
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                      <img src="{{ url($article->image) }}" width="100%" height="100px" alt="">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    <label class="custom-toggle">
                                        <input type="checkbox" id="active" name="active" value="1" {{ $article->active ? 'checked' : '' }} >
